...
public:
    ...
    void ItemTextureManager(int tile, int camX, int camY, int xPos, int yPox, int size);
private:
    ...
    void m_RenderDroppedItem(Texture2D& texture, int xPos, int yPos, int camX, int camY, int size);
